...
<body>
	...
	<ul>
		<li>요청이 오면 URI에 해당하는 알맞은 자원을 응답하는 프로그램(웹서버)</li>
	...
	<ul>
		...
		<li>단순 응답이 아니라 상황에 따라 변화하는 동적 페이지 처리를 담당한다</li>
	...
	<%--
		...
		<%= %> : 자바에 있는 값을 HTML로 출력할 수 있다 (out.print()의 축약형)
	...
	--%>
	 ...
	 <%!
	 	// <pre> : 웹 페이제내에서 텍스트의 모양을 그대로 유지할 수 있는 태그
