...
<body>
	...
	<ul>
		...
		<li>종류로는 application, session, request, page가 있다 (Scope라고 부름(범위))</li>
	</ul>
	...
	<dl>
		...
		<dd>
			...
			모든 서블릿에서 접근할 수 있다. (전역 static 변수같은 느낌)			
		</dd>
		...
		<dd>
			하나의 요청이 만료되기전(요청에 대한 응답을 하기 전)까지 유지되는 어트리뷰트.
			forward, include가 진행되는 동안 유지되기 때문에 다음 처리로 데이터를 전달하는 용도로 많이 사용된다.
		</dd>
		<dt>4. page scope</dt>
		<dd>
